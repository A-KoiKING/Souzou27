...
{
    CCP1CONbits.CCP1MODE = 0b1111 ;
    CCPTMRSbits.C1TSEL = tsel;
    CCP1CONbits.CCP1EN = 1;
}

void init_ccp2(const unsigned char tsel)
{
    CCP2CONbits.CCP2MODE = 0b1111 ;
    CCPTMRSbits.C2TSEL = tsel;
    CCP2CONbits.CCP2EN = 1;
}

void init_ccp3(const unsigned char tsel)
{
    CCP3CONbits.CCP3MODE = 0b1111 ;
    CCPTMRSbits.C3TSEL = tsel;
    CCP3CONbits.CCP3EN = 1;
}

void init_ccp4(const unsigned char tsel)
{
    CCP4CONbits.CCP4MODE = 0b1111 ;
    CCPTMRSbits.C4TSEL = tsel;
